...
// Products catalog and detail page
Route::get('/products', [ProductController::class, 'index'])->name('products.index');
Route::get('/products/{id}', [ProductController::class, 'show'])->name('products.show');

// Cart (accessible to guests to support session-based cart)
...
// Wishlist (accessible to guests via session)
...
// Legacy product category sub-routes (kept for backwards compatibility)
...
Route::middleware('auth')->group(function () {
    ...
    // Legacy wishlist routes (kept for auth-only wishlist operations)
...
// ============================================================
// Auth scaffold routes (login, register, password reset, etc.)
// ============================================================
